...
When generating dashboard visualizations involving area-related variables—such as `farm_site_area`, `productive_area`, and similar metrics—we apply dynamic outlier filtering based on country and date range. This ensures users receive clean, representative data even in visual summaries.
