...
![Litefarm Interface](posts/identifying_outliers/posts/identifying_outliers/img/Litefarm.png)
...
The first step in our analysis was to examine the **vertex distribution** of the field polygons to understand their general characteristics and ensure data quality. A box plot was created to visualize the distribution of vertex counts: ![boxplot of vertices' number distribution](posts/identifying_outliers/img/boxplot.png)
...
![histogram of number of veritces](posts/identifying_outliers/img/number_of_vertices.png)
...
-   **Perimeter Comparison**\
    ![Perimeter Scatter Plot](posts/identifying_outliers/img/perimeter1.png)

-   **Area Comparison**\
    ![Area Scatter Plot](posts/identifying_outliers/img/area1.png)
...
![The standardized polygon](posts/identifying_outliers/img/resampled_polygon.png)
...
![perimeter comparison](posts/identifying_outliers/img/resamples_perimeter.png)

-   **Area Comparison**

![area comparison](posts/identifying_outliers/img/resampled_area.png)
...
![The global mean shape](posts/identifying_outliers/img/mean_shape.png)

The following image illustrates the original polygon and its alignment with the Fréchet mean:

![Aligned Shape](posts/identifying_outliers/img/aligned_shape.png)
...
![Summary of Countries' Mean Shapes](posts/identifying_outliers/img/output.png)
...
![Field polygons and Fréchet mean for Zambia](posts/identifying_outliers/img/small_number_country1.png)

#### Chile

![Field polygons and Fréchet mean for Chile](posts/identifying_outliers/img/small_number_country.png)
...
![Satellite plot for all 51 potential fake fields](posts/identifying_outliers/img/satelite.png)
